  ...
  User.create(req.body, (err, user) => {
    ...
    const mailData = {
      ...
      <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <p>Thanks for signing up with Expense Tracker! You must follow this link with the following Verification Code to activate your account: </p>
        <p> https://expense-tracker-by-piku.herokuapp.com/users/verifyEmail </p>
